...
offense_gg <- total1%>%ggplot(aes(y=OffenseCategory, fill=season))+geom_bar() +
  xlab("Total Offenses") + ylab("Types of Offenses") + ggtitle("Total Offenses by Season, 2020-2021")
...
offenses_season <-total1%>%filter(OffenseCategory =="Larceny Offenses")%>%ggplot(aes(y=OffenseType, fill=season))+geom_bar() +
  xlab("Total Larceny Offenses") + ylab("Types of Larceny Offenses") + ggtitle("Larceny by Season, 2020-2021")
